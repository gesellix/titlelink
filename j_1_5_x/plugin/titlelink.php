<?php
/**
 * @copyright Copyright (C) 2005 - 2011 Tobias Gesellchen. All rights reserved.
...
class plgSystemTitleLink extends JPlugin
{
  ...
  var $dir = 'plugins/system/titlelink_plugins';
   ...
   */
  function plgSystemTitleLink(&$subject, $params)
  {
  ...
  function onLinkrLoadJS($version)
  {
    if ($this->linkr_enabled && $version >= 2.2 && 2 == 1) {
      ...
      $doc->addScript('plugins/system/titlelink_plugins/linkr_script.js');
  ...
  public function onAfterRender()
  {
    ...
    $option = JRequest::getVar('view');
    $layout = JRequest::getVar('task');
    if ($option == 'article' && $layout == 'edit') {
      return true;
    }
   ...
   */
  public function onPrepareContent_(&$article, &$params, $limitstart)
  {
